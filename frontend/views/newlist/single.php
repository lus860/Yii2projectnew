            ...
            <div class="single-feature-post video-post bg-img pager-article" style="background-image: url(<?='/img/bg-img/'.$model->getPrev()->img ?>);">
                ...
                <div class="post-content">
                    ...
                    <div class="post-meta d-flex">
                        ...
                        <a href="#"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <<?=$model->likes_count?>?></a>
                    </div>
                </div>
                <!-- Video Duration -->
                    ...
                    <div class="post-details-content">
                        ...
                        <div class="blog-content">
                            ...
                            <div class="post-content mt-0">
                                <a href="#" class="post-cata cata-sm cata-danger"><?= $category ?></a>
                                <a href="single-post.html" class="post-title mb-2"><?=$model->title?></a>
